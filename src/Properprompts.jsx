...
const Properprompts = () => {
  ...
  return (
    <div>
      <div 
        className="main" 
        style={{ backgroundImage: bgImage, backgroundSize: 'cover', height: '1050px', backgroundPosition: 'center' }}
      >
        {navi && (
      ...
      <div className='text-center'>
        <h2 className='ani'>YOU COPY AND PASTE</h2>
        <h2>GENERATIVE AI PROMPT BUILDER</h2>
        <h2>TO CONCEPTUALISE FASTER AND</h2>
        <h2>CREATE BETTER PHOTOGRAPHY.</h2>

        <div>
          <img className='thinkk' src={think} alt="" />
        </div>
      </div>

      <div className='last'>
        <h3 className='text-light'><LuInstagram /></h3>
        <div>
